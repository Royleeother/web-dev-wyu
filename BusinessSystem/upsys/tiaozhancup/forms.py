...
class TiaozhancupForm(ModelForm):
    ...
    request_type =  forms.ChoiceField(label='申报种类', choices=shenbaozlei, 
                    widget=forms.Select(attrs={'class': 'form-control',
                                            }))  
...
class TiaozhancupForm_forboss(ModelForm):                               
    ...
    class Meta:
        ...
        exclude = (
            ...
            'recommend_office',
            'recommend_address',
            'recommend_postal_code',
            'recommend_mobile_number',
            'recommend_home_number',
            'recommend_fact_check',
            'recommend_comment',
            'recommend_other_comment',
...
class Tiaozhancup_for_review_boss(forms.Form):
    grade = forms.CharField(label='打分', 
                    widget=forms.TextInput(
                                    attrs={'class': 'form-control',
                                    'placeholder': '100分制',
                                }))
