...
class Tiaozhancup(models.Model):
    ...
    request_type = models.CharField('申报种类', max_length=50, null=True)
    ...
    postal_code_user = models.CharField('常住邮政编码', max_length=50, null=True)
    ...
    recommend_title = models.CharField('推荐人职称', max_length=50, null=True, blank=True)
    ...
    recommend_home_number = models.CharField('推荐人住宅号码', max_length=50, null=True, blank=True)
    recommend_fact_check = models.CharField('推荐人请对申报者申报情况的真实性作出阐述', max_length=1000, null=True)
    recommend_comment = models.CharField('推荐人请对作品的意义、技术水平、适用范围及推广前景作出评价', max_length=2000, null=True)
    recommend_other_comment = models.CharField('推荐人其他说明', max_length=1000, null=True, blank=True)
    #作品信息
    ...
    class_three = models.CharField('三级分类', max_length=50, null=True, blank=True)
    class_four = models.CharField('四级分类', max_length=50, null=True, blank=True)
    short_intro = models.CharField('简介', max_length=1000, null=True)
    detail_intro = models.CharField('详细介绍', max_length=4000, null=True)
    project_logic = models.CharField('作品设计、发明的目的和基本思路、创新点、技术关键和主要技术目标：', max_length=500, null=True)
    technique_point = models.CharField('作品的科学性、先进性', max_length=1000, null=True)
    project_past = models.CharField('作品在何时何地何种机构举行的评审、鉴定、评比、展示等活动中获奖及鉴定结果', max_length=1000, null=True)
    project_stage = models.CharField('作品所处阶段', max_length=300, null=True)
    technique_transport_method = models.CharField('技术转让方式', max_length=300, null=True)
    project_show_way = models.CharField('作品可展示形式', max_length=300, null=True)
    project_predict = models.CharField('使用说明及该作品的技术特点和优势，提供该作品的适用范围及推广前景的技术性说明及市场分析和经济效益预测', max_length=2000, null=True)
    project_patent = models.CharField('专利申报情况', max_length=500, null=True)
    project_problem_statement = models.CharField('当前国内外同类型课题研究水平概述', max_length=2000, null=True)
    #上传
    ...
    #
    postscript = models.CharField('备注', max_length=200, null=True, blank=True)
    # 审核状态
    upload_time = models.CharField('提交时间:', max_length=100, null=True, blank=True)
