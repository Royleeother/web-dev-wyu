...
class Contest1(models.Model):
    ...
    apply_place_number = models.CharField(max_length=50, null=True)
    ...
    #
    is_review_by_stage1 = models.BooleanField('厅室管理员正在审核', default=False, null=True)
    is_review_by_stage2 = models.BooleanField('校律委人员正在审核', default=False, null=True)
    is_review_by_stage3 = models.BooleanField('团委人员正在审核', default=False, null=True)
    #
