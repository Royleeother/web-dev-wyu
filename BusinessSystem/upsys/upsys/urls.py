...
from dashboard import views, change_password
...
urlpatterns = [
    ...
    # 重置密码
    path('password-reset/',
         change_password.CustomPasswordResetView.as_view(),
         name='password_reset'),
    ...
    #
    # 比赛、表单、莽！！！
    path('contest1/', include('contest1.urls')),
    path('tiaozhancup/', include('tiaozhancup.urls')),
]
