...
class Tiaozhancup(models.Model):
    ...
    #
    scool_staff_give = models.CharField(max_length=500, null=True, default='{}',)
    college_staff_give = models.CharField(max_length=500, null=True, default='{}',)
    boss_staff_give = models.CharField(max_length=500, null=True, default="{}",)
    #
