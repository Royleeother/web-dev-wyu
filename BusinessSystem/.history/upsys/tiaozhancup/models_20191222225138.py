...
class Tiaozhancup(models.Model):
    ...
    #
    scool_staff_give = models.CharField(max_length=500, null=True)
    college_staff_give = models.CharField(max_length=500, null=True)
    boss_staff_give = models.CharField(max_length=500, null=True)
    #
