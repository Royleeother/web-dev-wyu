...
def contest_status_dict(user, contest_list, chinese_name):
    contest_dict = {}
...
def dashboard(request):
    ...
    if request.user.is_student:
        ...
        student_contest_status = contest_status_dict(user, student_contest, student_contest_chinese)
