...
class Contest1(models.Model):
    ...
    # 意见
    guiding_unit_decision = models.BooleanField('厅室管理员决定', null=True)
    discipline_unit_decision = models.BooleanField('校律委决定', null=True)
    ccyl_decision = models.BooleanField('团委决定', null=True)
    # 留言
    guiding_unit_comment = models.CharField('厅室管理员留言:', max_length=100, null=True)
    discipline_unit_comment = models.CharField('校律委留言:', max_length=100, null=True)
    ccyl_comment = models.CharField('团委留言:', max_length=100, null=True)
