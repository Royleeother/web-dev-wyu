...
class Contest1(models.Model):
    ...
    # 留言
    guiding_unit_comment = models.CharField(max_length=100, null=True)
    discipline_unit_comment = models.CharField(max_length=100, null=True)
    ccyl_comment = models.CharField(max_length=100, null=True)
