...
class Contest1_for_guiding_unit(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'guiding_unit_decision': forms.RadioSelect(choices=YES_NO, attrs={'class': 'form-control', }, required=False),
            'guiding_unit_comment': forms.TextInput(attrs={'class': 'form-control',
                                        'placeholder': '简短说明',
                                    }),
        }
