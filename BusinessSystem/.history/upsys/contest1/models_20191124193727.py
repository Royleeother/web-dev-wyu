...
class Contest1(models.Model):
    ...
    # 留言
    guiding_unit_comment = models.CharField('留言:', max_length=100, null=True)
    discipline_unit_comment = models.CharField('留言:', max_length=100, null=True)
    ccyl_comment = models.CharField('留言:', max_length=100, null=True)
