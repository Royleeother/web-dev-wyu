...
from .forms import Contest1Form, Contest1_for_guiding_unit
...
def reviewpage(request):
    ...
    test = Contest1_for_guiding_unit(instance=gg)
    ...
    if request.method == 'POST':
        form = Contest1_for_guiding_unit(data=request.POST)
        if form.is_valid():
            print("valid valid valid\r\n")
            profile = form.save(commit=False)
            print("save succces !!! 1111\r\n")
            print("student student: ", gg.student)
            profile.student = gg.student
            profile.save()
